...
#    print("output y_hat: ", y)
    ...
    tittle = "prediction_score_for_" + video_name
    plt.xlabel(xLab)
    plt.ylabel(yLab)
    plt.title(tittle)
    plt.grid(True)
...
# python inference.py -dataset "summe" -video_name "Kids_playing_in_leaves" -model_weight "model_weights/summe_random_non_overlap_0.5359.tar.pth"

# 'Air_Force_One', 'Base jumping', 'Kids_playing_in_leaves'