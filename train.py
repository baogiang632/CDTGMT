...
def train(params_obj):
    ...
    for aperture in params_obj.apertures:
        for cmb in params_obj.combis:
            ...
            print('params_obj.output_dir:', params_obj.output_dir)
            ...
            for split_filename in params_obj.splits:
                ...
                print('os.path.sep:', os.path.sep)
                print('model_anchor:', model_anchor)
                print('split_filename.split:',split_filename.split(os.path.sep)[-1][:-5])
                # f2 = open(params_obj.output_dir + os.path.sep + model_anchor + '_results_' + split_filename.split(os.path.sep)[-1][:-5]+'.txt', 'wt')
                f2 = open(params_obj.output_dir + os.path.sep + split_filename.split(os.path.sep)[-1][:-5]+'.txt', 'wt')
